...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `keys` varchar(500) COLLATE utf8_czech_ci NOT NULL,
  `h1` varchar(255) COLLATE utf8_czech_ci NOT NULL,
  `order` int(11) NOT NULL,
  `active` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
-- Exportování dat pro tabulku esh-op.menu: ~1 rows (přibližně)
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
INSERT INTO `menu` (`id`, `parent_id`, `name`, `e_name`, `title`, `keys`, `h1`, `order`, `active`) VALUES
	(1, 0, 'Homepage', '', 'Homepage', 'homepage', 'homepage', 1, 1);
