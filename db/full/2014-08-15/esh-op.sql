...
-- Exportování struktury pro tabulka esh-op.product_attribute
...
-- Exportování dat pro tabulku esh-op.product_attribute: ~0 rows (přibližně)
/*!40000 ALTER TABLE `product_attribute` DISABLE KEYS */;
INSERT INTO `product_attribute` (`id`, `id_product`, `id_attribute`, `price`, `weight`) VALUES
	(1, 1, 1, 3000, 20),
	(2, 1, 2, 4000, 25),
	(3, 1, 3, 5000, 35);
